...
CMS_COOKIES = dict(
    c360_oa_user_info="MmlNRGFrcWxMVXNkTzdDZzFzbjU1eVV4LzFBa2VTOUJoWjB2Y2xkZUx4MzIzMWtaamt0SUVTTGVhcXdXMU5oZkZFUHVpTlRPdDd5cURHMGhwUEdpZ3UyM20xNG9NSWNLZVBNZmhnbVFqcW54blF4Q3M0QkVOWHBkRHllUmhNeVIxL1JYYVdPenlTY09vdGxZQitlVm1TcjB0TWpqc1BWYTZ0R0hLQjd0V0xnMlFqSHRZN3VMbEE9PQ====")
CMS_URL = r"https://comfort-qa.camera360.com/backend"
UPLOAD_PIC_URL = r"/god/upload?utag=comm"
UPLOAD_ZIP_URL = r"/god/upload?utag=comm"
# SUBMIT_URL = r"/god/transmit"
SUBMIT_URL = r"/god/proxy"
...
def submit_sticker_api(pic_url, zip_data, platform, sticker_name, category_id, has_music=False, is_theme='1'):
    ...
    pay_load = {
        ...
        'multi_icon[de_de]': '',
        'multi_icon[other]': '',
        'multi_display_name[en]': '',
        'multi_display_name[zh_cn]': '',
        'multi_display_name[zh]': '',
        'multi_display_name[th]': '',
        'multi_display_name[ja]': '',
        'multi_display_name[in]': '',
        'multi_display_name[vi]': '',
        'multi_display_name[ko]': '',
        'multi_display_name[pt]': '',
        'multi_display_name[pt_br]': '',
        'multi_display_name[es]': '',
        'multi_display_name[es_es]': '',
        'multi_display_name[es_mx]': '',
        'multi_display_name[ru]': '',
        'multi_display_name[hi]': '',
        'multi_display_name[ar]': '',
        'multi_display_name[tr]': '',
        'multi_display_name[de]': '',
        'multi_display_name[de_de]': '',
        'multi_display_name[other]': '',
        'icon_tag_pic': '',
